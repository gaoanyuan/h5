module.exports = {
  ...
  url:"http://localhost:7000/#/app/demo.json/edit/pwaJwEI/text/pULkby9/property",
  // 阿里云的根 AK, 用来配置 RAM, 不会暴露在前端
  accessKeyId: 'CFL7nbksK6zGiF1P',
  secretAccessKey: 'k4kBAvlSp3cLqYYPhaBJBUjkEQBaxp',

  // 在准备工作阶段创建的 OSS bucket
  bucket: 'gaoay-sh-open5',
  ...
  publicImageHost: 'http://gaoay-sh-open5.img-cn-shanghai.aliyuncs.com',
  publicBgHost: 'http://gaoay-sh-open5.img-cn-shanghai.aliyuncs.com',
  userImageHost: 'http://gaoay-sh-open5.img-cn-shanghai.aliyuncs.com',
  userBgHost: 'http://gaoay-sh-open5.img-cn-shanghai.aliyuncs.com',
