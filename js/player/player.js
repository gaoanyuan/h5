  ...
  Player.create = function(id, theData) {
    ...
    var player = StateMachine.create({
        ...
        buildLinks: function (data) {
          ...
          player.wrapper.find('.element').on('click', function(e) {
            ...
            if(type == 'submit') {
              ...
              for(var i = 0; i < elems.length; i++) {
                ...
                switch(elem.attr('type')) {
                  case 'input':
                    ...
                    result[input.attr('target')] = input.val();
                    break;
                  case 'rating':
                    break;
                  case 'singleselect':
              ...
              window.parent.submitFunction(result);
            }
          });
        },
      ...
      callbacks: {
        ...
        onpreview_state: function (event, from, to, pageType) {
          Player.initPage(player);
          ...
          if(!pageType){
            ...
            for(var index in theData.pages){
              var page = theData.pages[index];
              if(page.pageType === pageType){
                player.setCurrentPage(page.id);
                break;
              }
            }
          }
