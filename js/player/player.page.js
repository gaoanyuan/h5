  ...
  window.Player.initPage = function(player) {
    var page = {
      ...
      buildInput: function(data) {
        var divStr = "<div></div>";
        return divStr + "<textarea style='padding: 8px;font-size: 16px;line-height: 16px' label='" + (data.label || "") + "' target='" + (data.target || "") + "' maxlength='" + (data.maxlength || 300) + "' placeholder='" + (data.placeholder || "") + "'></textarea>";
      },
